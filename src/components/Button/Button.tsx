...
export default function Button({
  ...
  const variants: { [key: string]: string } = {
    ...
    login:
      "bg-link text-white md:text-[18px] shadow-lg font-bold py-2 sm:py-2 px-4 sm:px-6 rounded-lg transition-all hover:brightness-110 hover:-translate-y-[2px] duration-200 ",
  };
