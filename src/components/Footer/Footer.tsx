  ...
  return (
    <div
      className={`bg-gradient-to-b ${
        isDark ? "from-[#1a2530] to-[#091316]" : "from-[#1a302c] to-[#091614]"
      }`}
    >
      <div className="text-center sm:text-left w-full mx-auto max-w-[1240px] py-20 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 px-[15px]">
        <div className="flex flex-col items-center sm:items-start pb-5">
          ...
          <p className="text-sm text-secondaryTxtDark py-2 sm:pr-7">
            {t.slogan}
          </p>
      ...
      <div
        className={`flex justify-center w-full text-xs text-secondaryTxtDark py-2 ${
          isDark ? "bg-footerBgCopyrightDark" : "bg-footerBgCopyright"
        }`}
      >
